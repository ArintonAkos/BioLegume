        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IndexImagePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IndexImageHash = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ImagePathId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ImagePathURL = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImagePaths_Listings_ListingId",
                        column: x => x.ListingId,
                        principalTable: "Listings",
                        principalColumn: "ListingId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ratings_AspNetUsers_FromUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StockChangeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ListingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    StockChangeDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Count = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    StockChangeType = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockChanges", x => x.StockChangeId);
                    table.ForeignKey(
                        name: "FK_StockChanges_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StockChanges_Listings_ListingId",
                        column: x => x.ListingId,
                        principalTable: "Listings",
                        principalColumn: "ListingId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockChanges_ListingId",
                table: "StockChanges",
                column: "ListingId");
